...
const val BUILD_RELEASE_FAT_FRAMEWORK_NAME = "buildReleaseFatFramework"

fun Project.registerBuildReleaseFatFramework() = tasks.register(BUILD_RELEASE_FAT_FRAMEWORK_NAME, FatFrameworkTask::class.java) {
